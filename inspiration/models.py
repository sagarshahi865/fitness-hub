...
class FitnessIcon(models.Model):
    ...
    image = models.ImageField(upload_to='icons/', blank=True, help_text='Upload an image')
    portrait_url = models.URLField(blank=True, help_text='Optional darker portrait crop')
    portrait = models.ImageField(upload_to='icons/portraits/', blank=True, help_text='Upload a portrait')
